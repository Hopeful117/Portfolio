...
<>
        ...
        <h1 className="text-4xl font-bold mb-2 text-white">Ludovic Brot</h1>
        <p className="text-xl text-white dark:text-gray-300">Développeur web junior en reconversion</p>
        <p className="mt-4 max-w-2xl text-white">Rigoureux, autonome et passionné, je recherche une alternance en CDA ou un premier poste dans une équipe technique pour contribuer à des projets concrets.</p>
      </section>
      

      <section className="mb-12 m-20 ">
       ...
       <section className="flex justify-center items-center m-50 bg-gray-900 text-white">
